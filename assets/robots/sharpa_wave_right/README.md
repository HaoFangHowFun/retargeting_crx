# Sharpa Wave right hand

Self-contained copy of the right hand with flange: 22 revolute joints,
35 links, no mimic joints, and 25 referenced STL meshes.

- URDF entry point: [urdf/right_sharpa_wave_with_flange.urdf](urdf/right_sharpa_wave_with_flange.urdf).
